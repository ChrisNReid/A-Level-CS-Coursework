...
class FinanceApp():
    ...
    def count(self):            
        ...
        print(self.eta , 'months till goal reached')
        self.etag = self.eta * 60 * 60 * 24 * 30.4
        self.etag2 = float(round(int(self.etag)))
        print(self.etag , 'seconds till goal reached')
        print(self.etag2 , 'rounded seconds to integers left')

        # self.count()
        self.countdown_button_callback()
        mtext='You have ',etag, ' untill your goal is reached'
        self.months_time=Label(self,text=mtext, font='Verdana 10 Bold')
        self.months_time.pack(anchor=S)
    ...
    def graph(self):
        ...
        #t_tip= self.me_percent + self.de_percent
        #if self.me_percent > 
    ...
    def countdown_button_callback(self):
        ...
        self.show_countdown(self.etag2)  ## default. please replace this
    ...
    def show_countdown(self, remaining_time = None):
        ...
        if self.remaining_time <= 0:
            self.countdown_label.configure(text="Congratulations! Goal achieved.")
        else:
            self.countdown_label.configure(text="%d seconds left" % self.remaining_time )
